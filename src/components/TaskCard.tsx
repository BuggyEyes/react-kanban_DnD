...
function TaskCard({task, deleteTask, updateTask}: Props) {
    ...
    if (isDragging)
        return <div ref={setNodeRef}
                    style={style}
                    className="bg-mainBackgroundColor  p-2 h-[100px] min-h-[100px]
    ...
    cursor-grab relative">
            ...
            <textarea className=" h-90% w-full resize-none border-none bg-transparent
    ...
    return (
        <div
            ...
            className="
    bg-mainBackgroundColor  p-2 h-[100px] min-h-[100px]
    items-center flex text-left rounded-xl
    hover:ring-2 hover:ring-inset hover:ring-rose-500
    cursor-grab relative"
        ...
        >
            ...
            {mouseIsOver && (
                <button
                    ...
                    className="
        stroke-white absolute
        right-4 top-1/2
        -translate-y-1/2 bg-columnBackgroundColor p-2
